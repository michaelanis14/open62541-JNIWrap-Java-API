...
public:
	...
	static UA_NodeId AddArrayMethod(ServerAPIBase *jAPIBase, UA_Server *server, UA_NodeId objectId, UA_NodeId requestedNewNodeId
	...
	static UA_NodeId CreateStringNodeId(UA_UInt16 nsIndex, UA_String name);
